...
#include "interfaces/srv/detail/set_process_bool__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::srv::SetProcessBool_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::SetProcessBool_Request & ros_message)
{
  // Member: enable
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::srv::SetProcessBool_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::SetProcessBool_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::srv::SetProcessBool_Request *>(
    untyped_ros_message);
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetProcessBool_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, SetProcessBool_Request)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetProcessBool_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::srv::SetProcessBool_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::SetProcessBool_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::srv::SetProcessBool_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::SetProcessBool_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::srv::SetProcessBool_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetProcessBool_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, SetProcessBool_Response)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetProcessBool_Response__handle;
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetProcessBool__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, SetProcessBool)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetProcessBool__handle;
}
